	...
	const inputValidation = async () => {
		...
		if (valid.email && valid.password) {
			...
			if (loginRequest.status == 200) {
				...
				// If the request was unsuccessful, add the invalid class and the animation class
				emailInput.classList.add(styles.invalid);
				emailInput.classList.add(styles.invalidAnimation);
		...
		>
			...
			<div className={styles.inputContainer}>
				<div>
					...
					/>
					<p>
						This is typically the email address you used to sign up
						to RandomMaths. In some cases this can be your school
						email address.
					</p>
				</div>
